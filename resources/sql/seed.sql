...
INSERT INTO posts(content, event_id, user_id, is_announcement) VALUES 
    ('Bring your coats guys, it is gonna be sunny', 1, 1, true),
    ('We are happy to inform you that there will be giveways in the event!', 1, 1, true),
    ('I hope you are excited for the event! Our speaker sure are!', 1, 1, true),
    ('To those who are wondering: Yes, the food is completely free.', 1, 1, true),
    ('The workshop that was going to take place in room B301 was moved to B303 due to logistics reasons. Thanks for the understanding.', 1, 1, true),
    ('Dont forget to follow us on the social networks!', 1, 1, true),
    ('Bring your umbrella guys, it is gonna be rainy!', 2, 6, true),
    ('The event might start 5 minutes later than expected due to logistics reasons. Thank you for your understanding.', 3, 7, true),
    ('Dont forget to bring your cameras, there will be good opportunities for good photos!', 4, 8, true),
    ('I advise you bring notepads to take your notes.', 5, 9, true),
    ('For those who want to bring food from home, there will be microwaves to heat up your food!', 6, 10, true),
    ('We announce that we will be offering lunch to the first 15 people to arrive! COME FAST!', 7, 11, true),
    ('I hope you guys are ready for the event of your lives!', 8, 12, true),
    ('Unfortunately, we are sad to inform that our guide Sarah is sick. However, Howard will cover her shift and we asure you he is just as competent. Thank you.', 9, 13, true),
    ('Bring your good mood, cuz so will we! ;)', 10, 14, true),
    ('Bring your coats guys, it is gonna be sunny', 11, 15, true),
    ('To those wondering if there will be food: yes. there will.', 12, 2, true),
    ('The event might start 15 minutes later than expected due to logistics reasons. Thank you for your understanding.', 13, 5, true),
    ('It is official: Drinks are on us!!', 14, 3, true),
    ('Bring your coats guys, it is gonna be sunny', 15, 7, true),
    ('We inform that reception will start 30 minutes before starting time. See you there.', 11, 2, true),
    ('Bring your coats guys, it is gonna be sunny', 7, 12, true),
    ('If you get lost, use your gps! Coordinates available in the event page', 2, 8, true),
    ('We will be having a goodies giveway, stay tuned for more information ;)', 9, 13, true),
    ('The event might start 10 minutes later than expected due to logistics reasons. Thank you for your understanding.', 13, 1, true),
    ('Amazing!!!!', 1, 2, false),
    ('Oh my god! I am so excited, last years edition was awesome.', 1, 3, false),
    ('They did a great job last year. Im having high hopes this year.', 1, 5, false),
    ('Last year I got my first summer internship thanks to this event!', 1, 7, false),
    ('So glad NIAEFEUP keeps organizing events for FEUPs students.', 1, 12, false),
    ('Another year, another Semana de Informática! Yey!', 1, 8, false),
    ('Eheheh, awesome you guys are organizing this event again. Go NIAEFEUP!', 1, 9, false),
    ('Nucleo de Informática you say? Interesting...', 1, 15, false),
    ('Legen - wait for it - dary! LEGENDARY!', 1, 14, false),
    ('Thank you! This is what I was needing!', 1, 13, false),
    ('Yey goodies!!!', 1, 4, false),
    ('I have been waiting for this basically all summer.', 2, 3, false),
    ('Well, looks like we are in for a good time.', 3, 4, false),
    ('Meh, kinda tired of these kind of events tbh.', 4, 5, false),
    ('Wooohooo, partyyyy!', 5, 6, false),
    ('Interesting initiative. Cheer from Chicago.', 6, 7, false),
    ('Amazing. This brings me back to my young day when I went travelling with my friends.', 7, 8, false),
    ('Yey! Big hug from Norway! Love your energy.', 8, 9, false),
    ('Cheers from Brazil.', 9, 19, false),
